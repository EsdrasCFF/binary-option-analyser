...
const tabsListVariants = cva(
  // max-w-full + overflow-x-auto: numa tela estreita, uma TabsList com muitas
  // abas (ou rótulos longos) rola horizontalmente dentro de si mesma em vez
  // de empurrar a página inteira pra largura maior (mesmo padrão já usado
  // pelo componente Table).
